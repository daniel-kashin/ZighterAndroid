...
public class CustomBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public CustomBottomSheetBehavior(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            mAnchorPoint = (int) a.getDimension(R.styleable.CustomBottomSheetBehavior_behavior_anchorPoint, 0);
        }
        a.recycle();
    ...
    public boolean onLayoutChild(CoordinatorLayout parent, V child, int layoutDirection) {
        ...
        if (mState == STATE_ANCHOR_POINT) {
            ViewCompat.offsetTopAndBottom(child, mParentHeight - mAnchorPoint);
    ...
    public void onStopNestedScroll(@NonNull CoordinatorLayout coordinatorLayout,
        ...
        if (mLastNestedScrollDy > 0) {
            ...
            int currentTop = child.getTop();
            if (currentTop > mParentHeight - mAnchorPoint) {
    ...
    private void setStateInternal(@android.support.design.widget.BottomSheetBehavior.State int state) {
        if (mState == state) {
            return;
        }
        mState = state;
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        SavedState(Parcelable superState, @android.support.design.widget.BottomSheetBehavior.State int state) {
            super(superState);
            this.state = state;
        }
