...
public class AnchorBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public boolean onLayoutChild(CoordinatorLayout parent, V child, int layoutDirection) {
        ...
        if (mState == STATE_EXPANDED) {
            ...
            ViewCompat.offsetTopAndBottom(child, mParentHeight - mAnchorOffset);
        }
    ...
    public void onStopNestedScroll(CoordinatorLayout coordinatorLayout, V child, View target) {
        ...
        if (mLastNestedScrollDy > 0) {
            ...
            if (shouldExpand(child, getYVelocity())) {
                ...
                top = mParentHeight - mAnchorOffset;
    ...
    public final int getAnchorOffset() {
        return mParentHeight - mAnchorOffset;
    }
    ...
    boolean shouldExpand(View child, float yvel) {
        ...
        return newTop < mParentHeight - mAnchorOffset;
    }

    boolean shouldCollapse(View child, float yvel) {
        int currentTop = child.getTop();
        if (currentTop > mParentHeight - mAnchorOffset) {
            return true;
        }
